 ...
 *
 *   This Class is the CuaimaCrypt's CRC64 used for data integrity validation .
 *
 *   Esta clase realiza el calcula de la redundancia ciclica CRC64 para verificar
 ...
 * @version 2.0.0
 */
public class CRC64 extends BaseHash {

    private static final int BLOCK_SIZE = 8; // inner block size in bytes
    /** The digest of the IHATEMATH message. */
    private static final String DIGEST0 = "E3DCADD69B01ADD1";
     ...
     */
    public CRC64() {
        super(Registry.CRC64_HASH, 8, BLOCK_SIZE);
        value = 0;
        encoding = HEX;
    }
    ...
    public void update(byte[] buf, int off, int len) {
        ...
        while (--len >= 0) {
            value = (value >>> 8) ^ crc64tab[(int) ((value ^ buf[off++]) & 0xff)];
            length++;
        }
    }
    ...
    /**
     * Returns the CRC64 data checksum computed so far.
     * @return CRC64 data checksum
     */
    ...
    /**
     * Retorna el Valor del CRC64 en un arreglo de bytes
     *
     * @return CRC64
     */
    @Override
    ...
    public boolean selfTest() {
        ...
        return DIGEST0.equals(StringUtils.toString(this.Hash("IHATEMATH".getBytes(StandardCharsets.ISO_8859_1))));
    }
