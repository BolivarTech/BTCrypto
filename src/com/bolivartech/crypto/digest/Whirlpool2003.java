 ...
 *
 * <ol>
 *    <li>The WHIRLPOOL Hashing Function.
 *    Vincent Rijmen.</li>
 * </ol>
 *
...
/*      if (DEBUG && debuglevel > 8) {
         ...
         for (i = 0 ;i < 64; i++){
            for (j = 0; j < 4; j++) {
               System.out.print("0x"+StringUtils.toString(T0[i*4+j])+", ");
            }
            System.out.println();
         }
         System.out.println();
         ...
         for (i = 0 ;i < 64; i++){
            for (j = 0; j < 4; j++) {
               System.out.print("0x"+StringUtils.toString(T1[i*4+j])+", ");
            }
            System.out.println();
         }
         System.out.println();
         ...
         for (i = 0 ;i < 64; i++){
            for (j = 0; j < 4; j++) {
               System.out.print("0x"+StringUtils.toString(T2[i*4+j])+", ");
            }
            System.out.println();
         }
         System.out.println();
         ...
         for (i = 0 ;i < 64; i++){
            for (j = 0; j < 4; j++) {
               System.out.print("0x"+StringUtils.toString(T3[i*4+j])+", ");
            }
            System.out.println();
         }
         System.out.println();
         ...
         for (i = 0 ;i < 64; i++){
            for (j = 0; j < 4; j++) {
               System.out.print("0x"+StringUtils.toString(T4[i*4+j])+", ");
            }
            System.out.println();
         }
         System.out.println();
         ...
         for (i = 0 ;i < 64; i++){
            for (j = 0; j < 4; j++) {
               System.out.print("0x"+StringUtils.toString(T5[i*4+j])+", ");
            }
            System.out.println();
         }
         System.out.println();
         ...
         for (i = 0; i < R; i++) {
            System.out.println("0x"+StringUtils.toString(rc[i]));
         }
         System.out.println();
 ...
 */
   ...
   public Whirlpool2003() {
      super(Registry.WHIRLPOOL_HASH, 64, BLOCK_SIZE);
   }
   ...
   public boolean selfTest() {
      ...
      return DIGEST0.equals(StringUtils.toString(new Whirlpool2003().digest()));
   }
