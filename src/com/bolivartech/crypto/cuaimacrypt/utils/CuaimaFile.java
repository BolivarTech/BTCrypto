 ...
 * </p>
 * <ul>
 * <li>v3.1.3 (2016-03-25) Se agrego el codigo de localizacion para la excepcion
 * y bitacoras.</li>
 * <li>v3.1.2 - Se forza la utilizacion del US-ASCII para las marcas del
 * encabezado.</li>
 ...
 */
@ThreadSafe
public class CuaimaFile implements CryptoFile, Runnable {

    // Codigo de identificacion de la clase
    private static final String CLASSID = "TR74ID3";
    ...
    private strictfp void CalcHeadPos(String Password) {
        ...
        try {
            ...
            this.BTLogF.LogMsg(LoggerManager.TYPE_ERROR, LoggerManager.LEVEL_ERROR, false, ex, null, CuaimaFile.CLASSID, "000");
        }
        if (HeadPos > 0.8) {
            HeadPos = 0.8;
        }
     ...
     */
    public CuaimaFile(LoggerManager Log) {
     ...
     */
    public CuaimaFile(int NumBlocks, LoggerManager Log) throws UtilsException {
        ...
        if (NumBlocks >= 2) {
            ...
            Progress = -1;
            throw new UtilsException("ERROR: NO se pudo inicializar CuaimaFile, la cantidad de bloques es menor a 2", ERROR_NUMBLCK, CuaimaFile.CLASSID + "001");
        }
    }
     ...
     * @throws UtilsException
     */
    public CuaimaFile(String Password, LoggerManager Log) throws UtilsException {
        ...
        synchronized (this) {
            ...
            if (CCPT.Password(Password) != 0) {
                PasswdLength = -1;
                Progress = -1;
                throw new UtilsException("ERROR: NO se pudo inicializar CuaimaFile, falla al inicializar el Password", ERROR_PASSWD, CuaimaFile.CLASSID + "002");
            } else {
     ...
     * @throws UtilsException
     */
    public CuaimaFile(String Password, int NumBlocks, LoggerManager Log) throws UtilsException {
        ...
        synchronized (this) {
            ...
            if (NumBlocks >= 2) {
                ...
                Progress = -1;
                throw new UtilsException("ERROR: NO se pudo inicializar CuaimaFile, la cantidad de bloques es menor a 2", ERROR_NUMBLCK, CuaimaFile.CLASSID + "003");
            }
            if (CCPT.Password(Password) != 0) {
                PasswdLength = -1;
                Progress = -1;
                throw new UtilsException("ERROR: NO se pudo inicializar CuaimaFile, falla al inicializar con el Password", ERROR_PASSWD, CuaimaFile.CLASSID + "004");
            } else {
                PasswdLength = Password.length();
                this.CalcHeadPos(Password);
            }
        ...
        if (CCPT != null) {
            synchronized (CCPT) {
                if (CCPT.Password(Passw) != 0) {
                    ...
                    throw new UtilsException("ERROR: NO se pudo inicializar la clave en CuaimaFile", ERROR_PASSWD, CuaimaFile.CLASSID + "005");
                } else {
    ...
    private void PrivCodec() throws UtilsException {
        ...
        if (FileParameters != null) {
            ...
            if (Input.getFileLength() > 0) {
                if (PasswdLength > 0) {
                    if (this.FileParameters.getInput().isFile()) {
                        synchronized (this) {
                            this.Progress = 0;
                        }
                        ...
                        Header[(int) (Header.length - 2)] = (Rand.nextLong() << 32) | (Converter.byte2long(new String("CCPTTPCC").getBytes(StandardCharsets.US_ASCII))[0] >>> 32);  // BYTES de OFUSCACION
                        Header[(int) (Header.length - 1)] = (Converter.byte2long(new String("CCPTTPCC").getBytes(StandardCharsets.US_ASCII))[0] << 32) | (Rand.nextLong() >>> 32);  // BYTES de OFUSCACION
                        ...
                        if (Output == null) {
                            OutputFileName = new String(InputFilePath + Separador + Input.getFileBaseName() + ".ccpt");
                            Output = new FileManager(OutputFileName);
                        } else if ((Output != null) && (Output.isDirectory())) {
                            OutputFileName = new String(Input.getFileBaseName() + ".ccpt");
                        ...
                        if (Output.Exists()) {
                            if (!Output.Delete()) {
                                ...
                                throw new UtilsException("ERROR: NO se pudo borrar el archivo de salida existente", ERROR_DELETEOUTFILE, CuaimaFile.CLASSID + "006");
                            }
                        }
                        try {
                            ...
                            throw new UtilsException("ERROR: NO se pudo crear el archivo " + Output.getAbsoluteFilePath(), ERROR_CREATEOUTFILE, CuaimaFile.CLASSID + "007");
                        }
                        try {
                            ...
                            throw new UtilsException("ERROR: NO se pudo abrir el archivo " + Input.getAbsoluteFilePath(), ERROR_OPENINFILE, CuaimaFile.CLASSID + "008");
                        }
                        ...
                        while (InputBuffer.length == NumBytesReads) {
                            try {
                                ...
                                throw new UtilsException("ERROR: NO se puedo leer el archivo a codificar", ERROR_NOREADINFILE, CuaimaFile.CLASSID + "009");
                            }
                            ...
                            if (NumBytesReads > 0) {
                                ...
                                if ((NumBlockWrite <= HPosc) && (NumBlockWrite + (NumBytesReads / 8) >= HPosc)) {
                                    ...
                                    try {
                                        ...
                                        throw new UtilsException("ERROR: NO se puede escribir en el archivo " + Output.getAbsoluteFilePath(), ERROR_WRITEOUTFILE, CuaimaFile.CLASSID + "010");
                                    }
                                    ...
                                    try {
                                        ...
                                        throw new UtilsException("ERROR: NO se puede escribir en el archivo " + Output.getAbsoluteFilePath(), ERROR_WRITEOUTFILE, CuaimaFile.CLASSID + "011");
                                    }
                        ...
                        try {
                            ...
                            throw new UtilsException("ERROR: NO se puede cerrar el archivo " + Input.getAbsoluteFilePath(), ERROR_CLOSEINFILE, CuaimaFile.CLASSID + "012");
                        }
                        try {
                            Output.Close();
                        } catch (UtilsException ex) {
                            ...
                            throw new UtilsException("ERROR: NO se puede cerrar el archivo " + Output.getAbsoluteFilePath(), ERROR_CLOSEOUTFILE, CuaimaFile.CLASSID + "013");
                        }
                    } else {
                        synchronized (this) {
                            this.Progress = -1;
                        }
                        throw new UtilsException("ERROR: NO se puede identificar el tipo de archivo a codificar", ERROR_INFILETYPE, CuaimaFile.CLASSID + "014");
                    }
                } else {
                    synchronized (this) {
                        this.Progress = -1;
                    }
                    throw new UtilsException("ERROR: Clave NO definida para codificar archivo", ERROR_PASSWD, CuaimaFile.CLASSID + "015");
                }
            } else {
                synchronized (this) {
                    this.Progress = -1;
                }
                throw new UtilsException("ERROR: Achivo de entrada tiene tamaño 0", ERROR_INPUTFILEZEROSIZE, CuaimaFile.CLASSID + "016");
            }
        } else {
            synchronized (this) {
                this.Progress = -1;
            }
            throw new UtilsException("ERROR: Archivos y Parametros de Codificacion NO Definidos", ERROR_FILEPARAMETERS, CuaimaFile.CLASSID + "017");
        }
        synchronized (this) {
            this.Progress = 100;
        }
                ...
                if (PasswdLength > 0) {
                    if (Input.isFile()) {
                        ...
                        try {
                            ...
                            throw new UtilsException("ERROR: NO se pudo abrir el archivo " + Input.getAbsoluteFilePath(), ERROR_OPENINFILE, CuaimaFile.CLASSID + "018");
                        }
                        ...
                        try {
                            ...
                            throw new UtilsException("ERROR: NO se pudo leer el archivo " + Input.getAbsoluteFilePath(), ERROR_NOREADINFILE, CuaimaFile.CLASSID + "019");
                        }
                        if (NumBytesReads == 32) {
                            ...
                            throw new UtilsException("ERROR: NO se pudo leer el archivo " + Input.getAbsoluteFilePath(), ERROR_NOREADINFILE, CuaimaFile.CLASSID + "020");
                        }
                        ...
                        if (HeaderDec.contentEquals(new StringBuffer("CCPTTPCC"))) {
                            ...
                            try {
                                ...
                                throw new UtilsException("ERROR: NO se pudo leer el archivo " + Input.getAbsoluteFilePath(), ERROR_NOREADINFILE, CuaimaFile.CLASSID + "021");
                            }
                            if (NumBytesReads == (8 * (HeaderLength - 4))) {
                                ...
                                throw new UtilsException("ERROR: NO se pudo leer el archivo " + Input.getAbsoluteFilePath(), ERROR_NOREADINFILE, CuaimaFile.CLASSID + "022");
                            }
                            ...
                            if (HeaderDec.contentEquals(new StringBuffer("CCPTTPCC"))) {
                                ...
                                if (Version == (VERSION & 0xFF)) {
                                    ...
                                    if (Output.Exists()) {
                                        if (!Output.Delete()) {
                                            ...
                                            throw new UtilsException("ERROR: NO se pudo borrar el archivo " + Output.getAbsoluteFilePath(), ERROR_DELETEOUTFILE, CuaimaFile.CLASSID + "023");
                                        }
                                    }
                                    ...
                                    try {
                                        ...
                                        throw new UtilsException("ERROR: NO se pudo crear el archivo " + Output.getAbsoluteFilePath(), ERROR_CREATEOUTFILE, CuaimaFile.CLASSID + "024");
                                    }
                                    ...
                                    try {
                                        ...
                                        throw new UtilsException("ERROR: NO se pudo abrir el archivo " + Input.getAbsoluteFilePath(), ERROR_OPENINFILE, CuaimaFile.CLASSID + "025");
                                    }
                                    synchronized (this) {
                                        InputBuffer = new byte[this.BufferSize]; // Buffer de Entrada
                                    }
                                    ...
                                    while (InputBuffer.length == NumBytesReads) {
                                        try {
                                            ...
                                            throw new UtilsException("ERROR: NO se pudo leer el archivo " + Input.getAbsoluteFilePath(), ERROR_NOREADINFILE, CuaimaFile.CLASSID + "026");
                                        }
                                        // Verifica si se leyeron datos
                                        if (NumBytesReads > 0) {
                                            ...
                                            if ((NumBlocksRead <= HPosc) && (NumBlocksRead + (NumBytesReads / 8) > HPosc)) {
                                                ...
                                                if ((DTemp + (8 * HeaderLength)) < InputBuffer.length) {
                                                    ...
                                                    try {
                                                        ...
                                                        throw new UtilsException("ERROR: NO se pudo leer el archivo " + Input.getAbsoluteFilePath(), ERROR_NOREADINFILE, CuaimaFile.CLASSID + "027");
                                                    }
                                                ...
                                                try {
                                                    ...
                                                    throw new UtilsException("ERROR: NO se pudo leer el archivo " + Input.getAbsoluteFilePath(), ERROR_NOREADINFILE, CuaimaFile.CLASSID + "028");
                                                }
                                                if (DTemp > 0) {
                                                ...
                                                if (Hash != null) {
                                                    ...
                                                    if ((NumBytesReads + Hash.hashSize()) < InputBuffer.length) {
                                                        ...
                                                        try {
                                                            ...
                                                            throw new UtilsException("ERROR: NO se pudo leer el archivo " + Input.getAbsoluteFilePath(), ERROR_NOREADINFILE, CuaimaFile.CLASSID + "029");
                                                        }
                                            ...
                                            try {
                                                ...
                                                throw new UtilsException("ERROR: NO se puede escribir en el archivo " + Output.getAbsoluteFilePath(), ERROR_WRITEOUTFILE, CuaimaFile.CLASSID + "030");
                                            }
                                    ...
                                    if (Hash != null) {
                                        ...
                                        if (!Arrays.equals(OrgDigest, NewDigest)) {
                                            ...
                                            throw new UtilsException("ERROR: HASH NO COINCIDEN", ERROR_HASHNOMACH, CuaimaFile.CLASSID + "031");
                                        }
                                    }
                                    try {
                                        Input.Close();
                                        ...
                                        throw new UtilsException("ERROR: NO se puede cerrar el archivo " + Input.getAbsoluteFilePath(), ERROR_CLOSEINFILE, CuaimaFile.CLASSID + "032");
                                    }
                                    try {
                                        Output.Close();
                                    } catch (UtilsException ex) {
                                        ...
                                        throw new UtilsException("ERROR: NO se puede cerrar el archivo " + Output.getAbsoluteFilePath(), ERROR_CLOSEOUTFILE, CuaimaFile.CLASSID + "033");
                                    }
                                }
                            } else {
                                synchronized (this) {
                                ...
                                throw new UtilsException("ERROR: NO se pudo Decodificar el archivo " + Input.getAbsoluteFilePath(), ERROR_DECODEC, CuaimaFile.CLASSID + "034");
                            }
                        } else {
                            synchronized (this) {
                                this.Progress = -1;
                            }
                            throw new UtilsException("ERROR: NO se pudo Decodificar el archivo " + Input.getAbsoluteFilePath(), ERROR_DECODEC, CuaimaFile.CLASSID + "035");
                        }
                        ...
                        throw new UtilsException("ERROR: NO se puede identificar el tipo de archivo a codificar", ERROR_INFILETYPE, CuaimaFile.CLASSID + "036");
                    }
                } else {
                    synchronized (this) {
                        this.Progress = -1;
                    }
                    throw new UtilsException("ERROR: Clave NO definida para decodificar archivo", ERROR_PASSWD, CuaimaFile.CLASSID + "037");
                }
            } else {
                synchronized (this) {
                    this.Progress = -1;
                }
                throw new UtilsException("ERROR: Achivo de entrada tiene tamaño 0", ERROR_INPUTFILEZEROSIZE, CuaimaFile.CLASSID + "038");
            }
        } else {
            synchronized (this) {
                this.Progress = -1;
            }
            throw new UtilsException("ERROR: Archivos de Decodificacion NO Definidos", ERROR_FILEPARAMETERS, CuaimaFile.CLASSID + "039");
        }
        synchronized (this) {
            this.Progress = 100;
        }
    ...
    public void run() {
        ...
        try {
            ...
            try {
                if (this.FileParameters.Input != null) {
                    if (this.FileParameters.Input.Exists()) {
                        this.FileParameters.Input.Close();
                    }
                }
                if (this.FileParameters.Output != null) {
                    if (this.FileParameters.Output.Exists()) {
                        if (this.FileParameters.Output.isFile()) {
                            this.FileParameters.Output.Close();
                            this.FileParameters.Output.Wipe();
                        }
                    }
                }
            } catch (UtilsException exx) {
                this.BTLogF.LogMsg(LoggerManager.TYPE_ERROR, LoggerManager.LEVEL_ERROR, false, exx, null, CuaimaFile.CLASSID, "040");
            }
            synchronized (this) {
                this.ErrorCode = ex.getErrorCode();
            }
            this.BTLogF.LogMsg(LoggerManager.TYPE_ERROR, LoggerManager.LEVEL_ERROR, false, ex, null, CuaimaFile.CLASSID, "041");
        } finally {
            synchronized (this) {
                this.Done = true;
            }
